function [F_x, F_y, F_x0, F_y0, M_z0] = PAC96(kappa, alpha, gamma, F_z, F_z0)
...
E_x = (p_Ex1 + p_Ex2.*df_z+p_Ex3.*df_z.^2).*(a-p_Ex4*sign(kappa_x)).*lambda_Ex;
...
B_ykappa = r_By1.*cos(atan(r_By2.*(alpha-r_By3)))+S_Vyk;
