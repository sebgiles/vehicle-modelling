...
T_f  =   1.2;   % front track
T_r  =  1.16;   % rear track
l_r  =  0.8;    %0.8112;   % CG to rear axle
l_f  =  0.8;    %0.748;   % CG to front axle
Z_f  = 0.255;   % CG height wrt front axle
Z_r  =  0.21;   % CG height wrt rear axle
h_CG =   0.3;   % CG height wrt ground
m    =   270;   % ;   % vehicle sprung mass with driver
...
k_f  = 35000;   % front spring stiffness
k_r  = 35000;   % rear spring stiffness
