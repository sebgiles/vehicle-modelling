...
%% TORQUES ON BODY
% wheel torque vectors wrt inertial frame
M_motor = [ Rz*Sfr*[0; MW_fr; 0] ...
            Rz*Sfl*[0; MW_fl; 0] ...
            Rz*Srr*[0; MW_rr; 0] ...
            Rz*Srl*[0; MW_rl; 0] ];
chi = [y(t);p(t);r(t)];
M_body = E \ ([0 -r_0 0; r_0 0 0; 0 0 0]*f*[1;1;1] + M_motor);
%% TORQUES ON WHEELS
...
%% LAGRANGE
% generalized forces
F_ext = [f(t); M_body(t); M_w(t);     M_f(t);     M_r(t)];
P_ext = [w(t);    chi(t); P_w(t); delta_f(t); delta_r(t)];
