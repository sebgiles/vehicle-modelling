...
[FX_fr, FY_fr, ~, ~] = C043pacejka96(SL_fr, SA_fr, 0, FZ_fr, tyreID);
[FX_fl, FY_fl, ~, ~] = C043pacejka96(SL_fl, SA_fl, 0, FZ_fl, tyreID);
[FX_rr, FY_rr, ~, ~] = C043pacejka96(SL_rr, SA_rr, 0, FZ_rr, tyreID);
[FX_rl, FY_rl, ~, ~] = C043pacejka96(SL_rl, SA_rl, 0, FZ_rl, tyreID);
